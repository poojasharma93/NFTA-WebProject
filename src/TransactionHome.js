                ...
                <nav className="navbar navbar-expand-lg navbar-light  navbar-default navbar-fixed-top">
                    <div>
                        <ul className="navbar-nav">
                            <li  id="open">
                                <NavLink to="/open" activeClassName="navbar2_li--active">Open</NavLink>
                            </li>
                            <li id="In Progress">
                                <NavLink to="/inprogress" activeClassName="navbar2_li--active">In Progress</NavLink>
                            </li>
                            <li id="Resolved">
                                <NavLink to="/resolved" activeClassName="navbar2_li--active">Resolved</NavLink>    
                            </li>
                        </ul>
